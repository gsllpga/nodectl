...
var (
	...
	configKeyCNMap = map[string]string{
		...
		"tg_bot_socks5_enabled":                   "Telegram Socks5 代理开关",
		"tg_bot_socks5_addr":                      "Telegram Socks5 代理地址",
		"tg_bot_socks5_user":                      "Telegram Socks5 用户名",
		"tg_bot_socks5_pass":                      "Telegram Socks5 密码",
